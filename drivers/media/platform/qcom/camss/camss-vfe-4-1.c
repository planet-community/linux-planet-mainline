...
#define VFE_0_DEMOSAIC_CFG			0x440
#define VFE_0_DEMOSAIC_WB_GAIN_0		0x518
#define VFE_0_DEMOSAIC_WB_GAIN_1		0x51c
#define VFE_0_DEMOSAIC_CLASSIFIER_x(x)		(0x520 + 0x4 * (x))
#define VFE_0_DEMOSAIC_INTERP_CFG_0		0x568
#define VFE_0_DEMOSAIC_INTERP_CFG_1		0x56c
...
{
	/*
	 * Set some reasonable defaults for the demosaic configuration.
	 * Qualcomm's camera HAL uses these values in most (if not all)
	 * cases. Leaving these registers untouched also produces a
	 * reasonable image, but may cause more artifacts to occur near
	 * edges.
	 */
	writel_relaxed(0x00400080, vfe->base + VFE_0_DEMOSAIC_WB_GAIN_0);
	writel_relaxed(0x00400080, vfe->base + VFE_0_DEMOSAIC_WB_GAIN_1);
	writel_relaxed(0x80003066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(0));
	writel_relaxed(0x81003066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(1));
	writel_relaxed(0x82003066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(2));
	writel_relaxed(0x83003066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(3));
	writel_relaxed(0x84003066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(4));
	writel_relaxed(0x85003066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(5));
	writel_relaxed(0x86003066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(6));
	writel_relaxed(0x87003066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(7));
	writel_relaxed(0x88003066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(8));
	writel_relaxed(0x803fe066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(9));
	writel_relaxed(0x813fe066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(10));
	writel_relaxed(0x823fe066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(11));
	writel_relaxed(0x833fe066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(12));
	writel_relaxed(0x843fe066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(13));
	writel_relaxed(0x853fe066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(14));
	writel_relaxed(0x863fe066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(15));
	writel_relaxed(0x873fe066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(16));
	writel_relaxed(0x883fe066, vfe->base + VFE_0_DEMOSAIC_CLASSIFIER_x(17));
	writel_relaxed(0x0080ff00, vfe->base + VFE_0_DEMOSAIC_INTERP_CFG_0);
	writel_relaxed(0x0001a020, vfe->base + VFE_0_DEMOSAIC_INTERP_CFG_1);
