 ...
 * camss-vfe-3-2.c
 *
 * Qualcomm MSM Camera Subsystem - VFE (Video Front End) Module v3.2
 *
...
#define VFE_0_MODULE_CFG_CROP			BIT(10)
#define VFE_0_MODULE_CFG_SCALE_Y		BIT(24)
#define VFE_0_MODULE_CFG_SCALE_CBCR		BIT(25)
...
#define VFE_0_IRQ_MASK_1_BUS_BDG_HALT_ACK		BIT(24)
#define VFE_0_IRQ_MASK_1_IMAGE_MASTER_n_BUS_OVERFLOW(n)	BIT((n) + 8)
#define VFE_0_IRQ_MASK_1_RDIn_REG_UPDATE(n)		BIT((n) + 26)
...
#define VFE_0_IRQ_STATUS_1_BUS_BDG_HALT_ACK		BIT(24)
#define VFE_0_IRQ_STATUS_1_RDIn_REG_UPDATE(n)		BIT((n) + 26)
...
#define VFE_0_BUS_XBAR_CFG_x(x)		(0x40 + 0x4 * ((x) / 4))
#define VFE_0_BUS_XBAR_CFG_x_M_PAIR_STREAM_EN			BIT(1)
#define VFE_0_BUS_XBAR_CFG_x_M_PAIR_STREAM_SWAP_INTER_INTRA	(0x3 << 3)
#define VFE_0_BUS_XBAR_CFG_x_M_SINGLE_STREAM_SEL_SHIFT		5
...
#define VFE_0_BUS_IMAGE_MASTER_n_WR_UB_CFG(n)		(0x058 + 0x18 * (n))
#define VFE_0_BUS_IMAGE_MASTER_n_WR_UB_CFG_OFFSET_SHIFT	16
#define VFE_0_BUS_IMAGE_MASTER_n_WR_IMAGE_SIZE(n)	(0x05c + 0x18 * (n))
#define VFE_0_BUS_IMAGE_MASTER_n_WR_BUFFER_CFG(n)	(0x060 + 0x18 * (n))

#define VFE_0_BUS_PING_PONG_STATUS	0x180

#define VFE_0_BUS_BDG_CMD		0x1d8
#define VFE_0_BUS_BDG_CMD_HALT_REQ	1

#define VFE_0_RDI_CFG_x(x)		((x) == 0 ? 0x6fc : 0x730 + (0x4 * (x)))
...
#define VFE_0_CAMIF_FRAME_CFG			0x1ec
...
#define VFE_0_SCALE_ENC_Y_H_IMAGE_SIZE		0x36c
#define VFE_0_SCALE_ENC_Y_H_PHASE		0x370
#define VFE_0_SCALE_ENC_Y_V_IMAGE_SIZE		0x374
#define VFE_0_SCALE_ENC_Y_V_PHASE		0x378
#define VFE_0_SCALE_ENC_CBCR_CFG		0x4e4
#define VFE_0_SCALE_ENC_CBCR_H_IMAGE_SIZE	0x4e8
#define VFE_0_SCALE_ENC_CBCR_H_PHASE		0x4ec
#define VFE_0_SCALE_ENC_CBCR_V_IMAGE_SIZE	0x4f0
#define VFE_0_SCALE_ENC_CBCR_V_PHASE		0x4f4

#define VFE_0_CROP_ENC_WIDTH			0x360
#define VFE_0_CROP_ENC_HEIGHT			0x364
...
{
	if (enable)
		writel_relaxed(0x00000009, vfe->base + VFE_0_BUS_CFG);
	else
				   ...
				   enum vfe_line_id line_id, u8 enable)
{
	...
	u32 irq_en1 = VFE_0_IRQ_MASK_1_IMAGE_MASTER_n_BUS_OVERFLOW(wm) |
		      VFE_0_IRQ_MASK_1_RDIn_REG_UPDATE(line_id) |
...
static void vfe_set_crop_cfg(struct vfe_device *vfe, struct vfe_line *line)
{
	...
	reg = (first << 16) | last;
	writel_relaxed(reg, vfe->base + VFE_0_CROP_ENC_WIDTH);

	first = line->crop.top;
	last = line->crop.top + line->crop.height - 1;
	reg = (first << 16) | last;
	writel_relaxed(reg, vfe->base + VFE_0_CROP_ENC_HEIGHT);
}
...
static void vfe_set_module_cfg(struct vfe_device *vfe, u8 enable)
{
	u32 val = VFE_0_MODULE_CFG_DEMUX |
		  ...
		  VFE_0_MODULE_CFG_SCALE_Y |
		  VFE_0_MODULE_CFG_SCALE_CBCR |
		  VFE_0_MODULE_CFG_CROP;
...
static irqreturn_t vfe_isr(int irq, void *dev)
{
	...
	for (i = VFE_LINE_RDI0; i <= VFE_LINE_RDI2; i++)
		if (value1 & VFE_0_IRQ_STATUS_1_RDIn_REG_UPDATE(i))
...
static const struct vfe_hw_ops_gen1 vfe_ops_gen1_3_2 = {
...
static void vfe_subdev_init(struct device *dev, struct vfe_device *vfe)
{
	...
	vfe->ops_gen1 = &vfe_ops_gen1_3_2;
	vfe->video_ops = vfe_video_ops_gen1;

	vfe->line_num = VFE_LINE_NUM_GEN1;
}

const struct vfe_hw_ops vfe_ops_3_2 = {
