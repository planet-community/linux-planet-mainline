...
static int s6d7aa0_ltl101at01_on(struct s6d7aa0_ltl101at01 *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0xc3, 0x40, 0x00, 0x08);
	mipi_dsi_dcs_write_seq(dsi, 0xbc, 0x01, 0x4e, 0x0b);
	mipi_dsi_dcs_write_seq(dsi, 0xfd, 0x16, 0x10, 0x11, 0x23, 0x09);
	mipi_dsi_dcs_write_seq(dsi, 0xfe, 0x00, 0x02, 0x03, 0x21, 0x80, 0x68);
...
static void s6d7aa0_ltl101at01_remove(struct mipi_dsi_device *dsi)
{
