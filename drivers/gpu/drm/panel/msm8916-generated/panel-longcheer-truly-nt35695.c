...
static int truly_nt35695_on(struct truly_nt35695 *ctx)
{
	...
	dsi_dcs_write_seq(dsi, 0x30, 0x6f);
	...
	dsi_dcs_write_seq(dsi, 0x09, 0x55);
	dsi_dcs_write_seq(dsi, 0x0a, 0x55);
	dsi_dcs_write_seq(dsi, 0x0d, 0x00);
	dsi_dcs_write_seq(dsi, 0x0b, 0x55);
	dsi_dcs_write_seq(dsi, 0x0c, 0x55);
	...
	dsi_dcs_write_seq(dsi, 0x78, 0x0c);
	dsi_dcs_write_seq(dsi, 0x79, 0x00);
	dsi_dcs_write_seq(dsi, 0x7a, 0x21);
	dsi_dcs_write_seq(dsi, 0x7b, 0x00);
	dsi_dcs_write_seq(dsi, 0x7c, 0x35);
	dsi_dcs_write_seq(dsi, 0x7d, 0x00);
	dsi_dcs_write_seq(dsi, 0x7e, 0x46);
	dsi_dcs_write_seq(dsi, 0x7f, 0x00);
	dsi_dcs_write_seq(dsi, 0x80, 0x56);
	dsi_dcs_write_seq(dsi, 0x81, 0x00);
	dsi_dcs_write_seq(dsi, 0x82, 0x64);
	dsi_dcs_write_seq(dsi, 0x83, 0x00);
	dsi_dcs_write_seq(dsi, 0x84, 0x72);
	dsi_dcs_write_seq(dsi, 0x85, 0x00);
	dsi_dcs_write_seq(dsi, 0x86, 0x7f);
	dsi_dcs_write_seq(dsi, 0x87, 0x00);
	dsi_dcs_write_seq(dsi, 0x88, 0xac);
	dsi_dcs_write_seq(dsi, 0x89, 0x00);
	dsi_dcs_write_seq(dsi, 0x8a, 0xd2);
	dsi_dcs_write_seq(dsi, 0x8b, 0x01);
	dsi_dcs_write_seq(dsi, 0x8c, 0x10);
	dsi_dcs_write_seq(dsi, 0x8d, 0x01);
	dsi_dcs_write_seq(dsi, 0x8e, 0x43);
	dsi_dcs_write_seq(dsi, 0x8f, 0x01);
	dsi_dcs_write_seq(dsi, 0x90, 0x95);
	dsi_dcs_write_seq(dsi, 0x91, 0x01);
	dsi_dcs_write_seq(dsi, 0x92, 0xd8);
	dsi_dcs_write_seq(dsi, 0x93, 0x01);
	dsi_dcs_write_seq(dsi, 0x94, 0xda);
	dsi_dcs_write_seq(dsi, 0x95, 0x02);
	dsi_dcs_write_seq(dsi, 0x96, 0x1a);
	dsi_dcs_write_seq(dsi, 0x97, 0x02);
	dsi_dcs_write_seq(dsi, 0x98, 0x63);
	dsi_dcs_write_seq(dsi, 0x99, 0x02);
	dsi_dcs_write_seq(dsi, 0x9a, 0x92);
	dsi_dcs_write_seq(dsi, 0x9b, 0x02);
	dsi_dcs_write_seq(dsi, 0x9c, 0xd1);
	dsi_dcs_write_seq(dsi, 0x9d, 0x02);
	dsi_dcs_write_seq(dsi, 0x9e, 0xfa);
	dsi_dcs_write_seq(dsi, 0x9f, 0x03);
	dsi_dcs_write_seq(dsi, 0xa0, 0x30);
	dsi_dcs_write_seq(dsi, 0xa2, 0x03);
	dsi_dcs_write_seq(dsi, 0xa3, 0x40);
	dsi_dcs_write_seq(dsi, 0xa4, 0x03);
	dsi_dcs_write_seq(dsi, 0xa5, 0x52);
	dsi_dcs_write_seq(dsi, 0xa6, 0x03);
	dsi_dcs_write_seq(dsi, 0xa7, 0x67);
	dsi_dcs_write_seq(dsi, 0xa9, 0x03);
	dsi_dcs_write_seq(dsi, 0xaa, 0x7d);
	dsi_dcs_write_seq(dsi, 0xab, 0x03);
	dsi_dcs_write_seq(dsi, 0xac, 0x99);
	dsi_dcs_write_seq(dsi, 0xad, 0x03);
	dsi_dcs_write_seq(dsi, 0xae, 0xb1);
	dsi_dcs_write_seq(dsi, 0xaf, 0x03);
	dsi_dcs_write_seq(dsi, 0xb0, 0xfb);
	...
	dsi_dcs_write_seq(dsi, 0xf2, 0x0c);
	dsi_dcs_write_seq(dsi, 0xf3, 0x00);
	dsi_dcs_write_seq(dsi, 0xf4, 0x21);
	dsi_dcs_write_seq(dsi, 0xf5, 0x00);
	dsi_dcs_write_seq(dsi, 0xf6, 0x35);
	dsi_dcs_write_seq(dsi, 0xf7, 0x00);
	dsi_dcs_write_seq(dsi, 0xf8, 0x46);
	dsi_dcs_write_seq(dsi, 0xf9, 0x00);
	dsi_dcs_write_seq(dsi, 0xfa, 0x56);
	dsi_dcs_write_seq(dsi, 0xff, 0x21);
	usleep_range(1000, 2000);
	dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	dsi_dcs_write_seq(dsi, 0x00, 0x00);
	dsi_dcs_write_seq(dsi, 0x01, 0x64);
	dsi_dcs_write_seq(dsi, 0x02, 0x00);
	dsi_dcs_write_seq(dsi, 0x03, 0x72);
	dsi_dcs_write_seq(dsi, 0x04, 0x00);
	dsi_dcs_write_seq(dsi, 0x05, 0x7f);
	dsi_dcs_write_seq(dsi, 0x06, 0x00);
	dsi_dcs_write_seq(dsi, 0x07, 0xac);
	dsi_dcs_write_seq(dsi, 0x08, 0x00);
	dsi_dcs_write_seq(dsi, 0x09, 0xd2);
	dsi_dcs_write_seq(dsi, 0x0a, 0x01);
	dsi_dcs_write_seq(dsi, 0x0b, 0x10);
	dsi_dcs_write_seq(dsi, 0x0c, 0x01);
	dsi_dcs_write_seq(dsi, 0x0d, 0x43);
	dsi_dcs_write_seq(dsi, 0x0e, 0x01);
	dsi_dcs_write_seq(dsi, 0x0f, 0x95);
	dsi_dcs_write_seq(dsi, 0x10, 0x01);
	dsi_dcs_write_seq(dsi, 0x11, 0xd8);
	dsi_dcs_write_seq(dsi, 0x12, 0x01);
	dsi_dcs_write_seq(dsi, 0x13, 0xda);
	dsi_dcs_write_seq(dsi, 0x14, 0x02);
	dsi_dcs_write_seq(dsi, 0x15, 0x1a);
	dsi_dcs_write_seq(dsi, 0x16, 0x02);
	dsi_dcs_write_seq(dsi, 0x17, 0x63);
	dsi_dcs_write_seq(dsi, 0x18, 0x02);
	dsi_dcs_write_seq(dsi, 0x19, 0x92);
	dsi_dcs_write_seq(dsi, 0x1a, 0x02);
	dsi_dcs_write_seq(dsi, 0x1b, 0xd1);
	dsi_dcs_write_seq(dsi, 0x1c, 0x02);
	dsi_dcs_write_seq(dsi, 0x1d, 0xfa);
	dsi_dcs_write_seq(dsi, 0x1e, 0x03);
	dsi_dcs_write_seq(dsi, 0x1f, 0x30);
	dsi_dcs_write_seq(dsi, 0x20, 0x03);
	dsi_dcs_write_seq(dsi, 0x21, 0x40);
	dsi_dcs_write_seq(dsi, 0x22, 0x03);
	dsi_dcs_write_seq(dsi, 0x23, 0x52);
	dsi_dcs_write_seq(dsi, 0x24, 0x03);
	dsi_dcs_write_seq(dsi, 0x25, 0x67);
	dsi_dcs_write_seq(dsi, 0x26, 0x03);
	dsi_dcs_write_seq(dsi, 0x27, 0x7d);
	dsi_dcs_write_seq(dsi, 0x28, 0x03);
	dsi_dcs_write_seq(dsi, 0x29, 0x99);
	dsi_dcs_write_seq(dsi, 0x2a, 0x03);
	dsi_dcs_write_seq(dsi, 0x2b, 0xb1);
	dsi_dcs_write_seq(dsi, 0x2d, 0x03);
	dsi_dcs_write_seq(dsi, 0x2f, 0xfb);
	...
	dsi_dcs_write_seq(dsi, 0x35, 0x0c);
	dsi_dcs_write_seq(dsi, 0x36, 0x00);
	dsi_dcs_write_seq(dsi, 0x37, 0x21);
	dsi_dcs_write_seq(dsi, 0x38, 0x00);
	dsi_dcs_write_seq(dsi, 0x39, 0x35);
	dsi_dcs_write_seq(dsi, 0x3a, 0x00);
	dsi_dcs_write_seq(dsi, 0x3b, 0x46);
	dsi_dcs_write_seq(dsi, 0x3d, 0x00);
	dsi_dcs_write_seq(dsi, 0x3f, 0x56);
	dsi_dcs_write_seq(dsi, 0x40, 0x00);
	dsi_dcs_write_seq(dsi, 0x41, 0x64);
	dsi_dcs_write_seq(dsi, 0x42, 0x00);
	dsi_dcs_write_seq(dsi, 0x43, 0x72);
	dsi_dcs_write_seq(dsi, 0x44, 0x00);
	dsi_dcs_write_seq(dsi, 0x45, 0x7f);
	dsi_dcs_write_seq(dsi, 0x46, 0x00);
	dsi_dcs_write_seq(dsi, 0x47, 0xac);
	dsi_dcs_write_seq(dsi, 0x48, 0x00);
	dsi_dcs_write_seq(dsi, 0x49, 0xd2);
	dsi_dcs_write_seq(dsi, 0x4a, 0x01);
	dsi_dcs_write_seq(dsi, 0x4b, 0x10);
	dsi_dcs_write_seq(dsi, 0x4c, 0x01);
	dsi_dcs_write_seq(dsi, 0x4d, 0x43);
	dsi_dcs_write_seq(dsi, 0x4e, 0x01);
	dsi_dcs_write_seq(dsi, 0x4f, 0x95);
	dsi_dcs_write_seq(dsi, 0x50, 0x01);
	dsi_dcs_write_seq(dsi, 0x51, 0xd8);
	dsi_dcs_write_seq(dsi, 0x52, 0x01);
	dsi_dcs_write_seq(dsi, 0x53, 0xda);
	dsi_dcs_write_seq(dsi, 0x54, 0x02);
	dsi_dcs_write_seq(dsi, 0x55, 0x1a);
	dsi_dcs_write_seq(dsi, 0x56, 0x02);
	dsi_dcs_write_seq(dsi, 0x58, 0x63);
	dsi_dcs_write_seq(dsi, 0x59, 0x02);
	dsi_dcs_write_seq(dsi, 0x5a, 0x92);
	dsi_dcs_write_seq(dsi, 0x5b, 0x02);
	dsi_dcs_write_seq(dsi, 0x5c, 0xd1);
	dsi_dcs_write_seq(dsi, 0x5d, 0x02);
	dsi_dcs_write_seq(dsi, 0x5e, 0xfa);
	...
	dsi_dcs_write_seq(dsi, 0x64, 0x52);
	dsi_dcs_write_seq(dsi, 0x65, 0x03);
	dsi_dcs_write_seq(dsi, 0x66, 0x67);
	dsi_dcs_write_seq(dsi, 0x67, 0x03);
	dsi_dcs_write_seq(dsi, 0x68, 0x7d);
	dsi_dcs_write_seq(dsi, 0x69, 0x03);
	dsi_dcs_write_seq(dsi, 0x6a, 0x99);
	dsi_dcs_write_seq(dsi, 0x6b, 0x03);
	dsi_dcs_write_seq(dsi, 0x6c, 0xb1);
	dsi_dcs_write_seq(dsi, 0x6d, 0x03);
	dsi_dcs_write_seq(dsi, 0x6e, 0xfb);
	...
	dsi_dcs_write_seq(dsi, 0x74, 0x0c);
	dsi_dcs_write_seq(dsi, 0x75, 0x00);
	dsi_dcs_write_seq(dsi, 0x76, 0x21);
	dsi_dcs_write_seq(dsi, 0x77, 0x00);
	dsi_dcs_write_seq(dsi, 0x78, 0x35);
	dsi_dcs_write_seq(dsi, 0x79, 0x00);
	dsi_dcs_write_seq(dsi, 0x7a, 0x46);
	dsi_dcs_write_seq(dsi, 0x7b, 0x00);
	dsi_dcs_write_seq(dsi, 0x7c, 0x56);
	dsi_dcs_write_seq(dsi, 0x7d, 0x00);
	dsi_dcs_write_seq(dsi, 0x7e, 0x64);
	dsi_dcs_write_seq(dsi, 0x7f, 0x00);
	dsi_dcs_write_seq(dsi, 0x80, 0x72);
	dsi_dcs_write_seq(dsi, 0x81, 0x00);
	dsi_dcs_write_seq(dsi, 0x82, 0x7f);
	dsi_dcs_write_seq(dsi, 0x83, 0x00);
	dsi_dcs_write_seq(dsi, 0x84, 0xac);
	dsi_dcs_write_seq(dsi, 0x85, 0x00);
	dsi_dcs_write_seq(dsi, 0x86, 0xd2);
	dsi_dcs_write_seq(dsi, 0x87, 0x01);
	dsi_dcs_write_seq(dsi, 0x88, 0x10);
	dsi_dcs_write_seq(dsi, 0x89, 0x01);
	dsi_dcs_write_seq(dsi, 0x8a, 0x43);
	dsi_dcs_write_seq(dsi, 0x8b, 0x01);
	dsi_dcs_write_seq(dsi, 0x8c, 0x95);
	dsi_dcs_write_seq(dsi, 0x8d, 0x01);
	dsi_dcs_write_seq(dsi, 0x8e, 0xd8);
	dsi_dcs_write_seq(dsi, 0x8f, 0x01);
	dsi_dcs_write_seq(dsi, 0x90, 0xda);
	dsi_dcs_write_seq(dsi, 0x91, 0x02);
	dsi_dcs_write_seq(dsi, 0x92, 0x1a);
	dsi_dcs_write_seq(dsi, 0x93, 0x02);
	dsi_dcs_write_seq(dsi, 0x94, 0x63);
	dsi_dcs_write_seq(dsi, 0x95, 0x02);
	dsi_dcs_write_seq(dsi, 0x96, 0x92);
	dsi_dcs_write_seq(dsi, 0x97, 0x02);
	dsi_dcs_write_seq(dsi, 0x98, 0xd1);
	dsi_dcs_write_seq(dsi, 0x99, 0x02);
	dsi_dcs_write_seq(dsi, 0x9a, 0xfa);
	dsi_dcs_write_seq(dsi, 0x9b, 0x03);
	dsi_dcs_write_seq(dsi, 0x9c, 0x30);
	dsi_dcs_write_seq(dsi, 0x9d, 0x03);
	dsi_dcs_write_seq(dsi, 0x9e, 0x40);
	dsi_dcs_write_seq(dsi, 0x9f, 0x03);
	dsi_dcs_write_seq(dsi, 0xa0, 0x52);
	dsi_dcs_write_seq(dsi, 0xa2, 0x03);
	dsi_dcs_write_seq(dsi, 0xa3, 0x67);
	dsi_dcs_write_seq(dsi, 0xa4, 0x03);
	dsi_dcs_write_seq(dsi, 0xa5, 0x7d);
	dsi_dcs_write_seq(dsi, 0xa6, 0x03);
	dsi_dcs_write_seq(dsi, 0xa7, 0x99);
	dsi_dcs_write_seq(dsi, 0xa9, 0x03);
	dsi_dcs_write_seq(dsi, 0xaa, 0xb1);
	dsi_dcs_write_seq(dsi, 0xab, 0x03);
	dsi_dcs_write_seq(dsi, 0xac, 0xfb);
	dsi_dcs_write_seq(dsi, 0xad, 0x03);
	...
	dsi_dcs_write_seq(dsi, 0xb3, 0x00);
	dsi_dcs_write_seq(dsi, 0xb4, 0x21);
	dsi_dcs_write_seq(dsi, 0xb5, 0x00);
	dsi_dcs_write_seq(dsi, 0xb6, 0x35);
	dsi_dcs_write_seq(dsi, 0xb7, 0x00);
	dsi_dcs_write_seq(dsi, 0xb8, 0x46);
	dsi_dcs_write_seq(dsi, 0xb9, 0x00);
	dsi_dcs_write_seq(dsi, 0xba, 0x56);
	dsi_dcs_write_seq(dsi, 0xbb, 0x00);
	dsi_dcs_write_seq(dsi, 0xbc, 0x64);
	dsi_dcs_write_seq(dsi, 0xbd, 0x00);
	dsi_dcs_write_seq(dsi, 0xbe, 0x72);
	dsi_dcs_write_seq(dsi, 0xbf, 0x00);
	dsi_dcs_write_seq(dsi, 0xc0, 0x7f);
	dsi_dcs_write_seq(dsi, 0xc1, 0x00);
	dsi_dcs_write_seq(dsi, 0xc2, 0xac);
	dsi_dcs_write_seq(dsi, 0xc3, 0x00);
	dsi_dcs_write_seq(dsi, 0xc4, 0xd2);
	dsi_dcs_write_seq(dsi, 0xc5, 0x01);
	dsi_dcs_write_seq(dsi, 0xc6, 0x10);
	dsi_dcs_write_seq(dsi, 0xc7, 0x01);
	dsi_dcs_write_seq(dsi, 0xc8, 0x43);
	dsi_dcs_write_seq(dsi, 0xc9, 0x01);
	dsi_dcs_write_seq(dsi, 0xca, 0x95);
	dsi_dcs_write_seq(dsi, 0xcb, 0x01);
	dsi_dcs_write_seq(dsi, 0xcc, 0xd8);
	dsi_dcs_write_seq(dsi, 0xcd, 0x01);
	dsi_dcs_write_seq(dsi, 0xce, 0xda);
	dsi_dcs_write_seq(dsi, 0xcf, 0x02);
	dsi_dcs_write_seq(dsi, 0xd0, 0x1a);
	dsi_dcs_write_seq(dsi, 0xd1, 0x02);
	dsi_dcs_write_seq(dsi, 0xd2, 0x63);
	dsi_dcs_write_seq(dsi, 0xd3, 0x02);
	dsi_dcs_write_seq(dsi, 0xd4, 0x92);
	dsi_dcs_write_seq(dsi, 0xd5, 0x02);
	dsi_dcs_write_seq(dsi, 0xd6, 0xd1);
	dsi_dcs_write_seq(dsi, 0xd7, 0x02);
	dsi_dcs_write_seq(dsi, 0xd8, 0xfa);
	dsi_dcs_write_seq(dsi, 0xd9, 0x03);
	dsi_dcs_write_seq(dsi, 0xda, 0x30);
	dsi_dcs_write_seq(dsi, 0xdb, 0x03);
	dsi_dcs_write_seq(dsi, 0xdc, 0x40);
	dsi_dcs_write_seq(dsi, 0xdd, 0x03);
	dsi_dcs_write_seq(dsi, 0xde, 0x52);
	dsi_dcs_write_seq(dsi, 0xdf, 0x03);
	dsi_dcs_write_seq(dsi, 0xe0, 0x67);
	dsi_dcs_write_seq(dsi, 0xe1, 0x03);
	dsi_dcs_write_seq(dsi, 0xe2, 0x7d);
	dsi_dcs_write_seq(dsi, 0xe3, 0x03);
	dsi_dcs_write_seq(dsi, 0xe4, 0x99);
	dsi_dcs_write_seq(dsi, 0xe5, 0x03);
	dsi_dcs_write_seq(dsi, 0xe6, 0xb1);
	dsi_dcs_write_seq(dsi, 0xe7, 0x03);
	dsi_dcs_write_seq(dsi, 0xe8, 0xfb);
	dsi_dcs_write_seq(dsi, 0xe9, 0x03);
	...
	dsi_dcs_write_seq(dsi, 0x3a, 0x6e);
